...
const Guideline = ({ course }) => {
  const { title, link, thumbnail, lastUpdated } = course;
  return (
    <>
      <div className="group relative overflow-hidden rounded-sm bg-white shadow-two duration-300 hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark min-h-[450px]">
        <Link to={link} className="relative block aspect-[37/22] w-full">
          ...
          <img
            ...
            }/guidelines/thumbnail/${thumbnail}`}
            alt="image"
